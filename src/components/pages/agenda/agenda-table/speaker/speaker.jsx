...
const Speaker = ({ avatar, name, role, bio, xUrl, linkedinUrl, githubUrl }) => {
  ...
  return (
    <>
      <button className="flex items-center gap-x-2.5" type="button" onClick={openModal}>
        {avatar && (
          <Image
      ...
      {bio && (
        <ReactModal
          ...
          className="relative top-1/2 left-1/2 max-h-[95%] w-[95%] max-w-[458px] -translate-x-1/2 -translate-y-1/2 rounded-[10px] px-6 pt-6 pb-7 bg-black text-white shadow-[0px_14px_56px_0px_rgba(0,229,153,0.12),0px_6px_10px_0px_rgba(0,0,0,0.25)] border border-gray-15"
          closeTimeoutMS={200}
