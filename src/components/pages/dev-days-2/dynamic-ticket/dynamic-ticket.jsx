...
const colorVariants = [
  {
    ...
    backgroundImage: ellipse1,
    buttonColorClass: 'before:bg-ticket-variant-1',
  },
  {
    id: 2,
    ...
    backgroundImage: ellipse2,
    buttonColorClass: 'before:bg-ticket-variant-2',
  },
  {
    id: 3,
    ...
    backgroundImage: ellipse3,
    buttonColorClass: 'before:bg-ticket-variant-3',
  },
  {
    id: 4,
    ...
    backgroundImage: ellipse4,
    buttonColorClass: 'before:bg-ticket-variant-4',
  },
];
